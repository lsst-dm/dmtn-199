...
The six requirements summarized above will be in place for the commissioning phase of the integrated Rubin Observatory system. Specifically, the requirements will pertain to data obtained with the LSST Camera in place on the telescope for commissioing and going forward into full survey operations. These added data security requirements in the present document do not apply to earlier phases of commissioing with the Commissioning Camera (also known as ComCam), nor to the data obtained in any phase at the Rubin Auxilliary Telescope (Auxtel). 
