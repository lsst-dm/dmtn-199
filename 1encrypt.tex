...
As outlined in \citeds{DMTN-108}  we propose to buy four routers which can perform IPsec AES-256 bit encryption between Chile and SLAC.
...
We have included, for completeness, in \tabref{tab:ipsec} the cost of avoiding the huawei equipment in Brazil. This is an FIU contract to install an alternative route around the equipment and have it operatied for 10 years.
