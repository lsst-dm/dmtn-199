\tiny \begin{longtable} {|p{0.5\textwidth}|p{0.1\textwidth}|p{0.4\textwidth} |} \caption{This table provides an overview of the \citeds{NIST.SP.800-171} and Rubin compliance with it. \label{tab:compliance}}\\
\hline
