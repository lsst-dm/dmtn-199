...
{3.10.4 Maintain audit logs of physical access.}&{}&{Y}&{Cristian - does the key card system keep an audit ?} \\ \hline
...
{3.13.6 Deny network communications traffic by default and allow network communications traffic by exception (i.e., deny all, permit by exception).}&{Y}&{Y}&{Cristian ..} \\ \hline
